...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('DB_PASSWORD', default='bookstore_pass_123'),
...
# CORS settings (para permitir requests desde cualquier origen en desarrollo)
CORS_ALLOW_ALL_ORIGINS = DEBUG


# Configuración del negocio - Tasas de cambio y márgenes
...
PROFIT_MARGIN = config('PROFIT_MARGIN', default=40, cast=int)
